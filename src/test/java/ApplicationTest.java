...
@Test
    ...
    $("[data-qa-node='firstNamedebitSource']").sendKeys("Anatolii");
    $("[data-qa-node='lastNamedebitSource']").sendKeys("Anatolivich");
    $("[data-qa-node='numberreceiver']").sendKeys("4004159115449003");
    $("[data-qa-node='firstNamereceiver']").sendKeys("Ivan");
    $("[data-qa-node='lastNamereceiver']").sendKeys("Ivanovich");
    ...
    $("[data-qa-node=receiver-name]").should(Condition.text("IVAN IVANOVICH"));
